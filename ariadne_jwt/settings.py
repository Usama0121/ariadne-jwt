...
DEFAULTS = {
    ...
    'JWT_EXPIRATION_DELTA': env.timedelta('JWT_EXPIRATION_DELTA', timedelta(seconds=60 * 5)),
    'JWT_ALLOW_REFRESH': env.bool('JWT_ALLOW_REFRESH', True),
    'JWT_REFRESH_EXPIRATION_DELTA': env.timedelta('JWT_REFRESH_EXPIRATION_DELTA', timedelta(days=7)),
    'JWT_ENCODE_HANDLER': env('JWT_ENCODE_HANDLER', default='ariadne_jwt.utils.jwt_encode'),
    'JWT_DECODE_HANDLER': env('JWT_DECODE_HANDLER', default='ariadne_jwt.utils.jwt_decode'),
    'JWT_PAYLOAD_HANDLER': env('JWT_PAYLOAD_HANDLER', default='ariadne_jwt.utils.jwt_payload'),
}
